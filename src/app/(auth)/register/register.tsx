            ...
            {({ isSubmitting }) => (
              <Form className="space-y-4">
                ...
                <button
                  ...
                  className="w-full rounded-lg mt-6 bg-[#1C2331] px-6 py-3 text-lg text-white transition-colorfocus:outline-none focus:ring-2 focus:ring-blue-500/20 "
                ...
                >
                  {isSubmitting ? (
                    <div className="flex items-center justify-center opacity-5">
                      ...
                      <p className="text-white">Creating Account .....</p>
                    </div>
                  ) : (
                    "Sign Up"
                  )}
